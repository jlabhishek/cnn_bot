...
class Environment():
	...
	def discretize_observation(self,new_ranges):
		...
		sensor_sq=sensor_val[0:3]*sensor_val[0:3] #square the values of front-facing sensors 1-8
		...
		for i, item in enumerate(data):
			...
			elif(item >=0.8 or np.isnan(item)):
	...
	def reset(self):
		...
		a,b=vrep.simxLoadModel(self.clientID, '/home/rip/BTP/V-REP_PRO_EDU_V3_4_0_Linux/models/Custom_model/Poineer_p3dx_3_sensors.ttm',0, vrep.simx_opmode_blocking)
